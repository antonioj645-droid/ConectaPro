...
class _AreaClientePageState extends State<AreaClientePage> {
  ...
  static const List<Map<String, String>> _banners = [
    {
      'imagem':    'assets/images/banner_arcondicionado.png',
      'titulo':    'Ar-Condicionado instalado hoje',
      'subtitulo': 'Técnicos próximos de você',
      'categoria': 'Refrigeração e Climatização',
    },
    {
      'imagem':    'assets/images/banner_eletricista.png',
      'titulo':    'Eletricista com segurança',
      'subtitulo': 'Segurança • Qualidade • Confiança',
      'categoria': 'Elétrica',
    },
    {
      'imagem':    'assets/images/banner_encanador.png',
      'titulo':    'Encanador na hora certa',
      'subtitulo': 'Solução que flui para você',
      'categoria': 'Hidráulica',
    },
    {
      'imagem':    'assets/images/banner_faxineira.png',
      'titulo':    'Faxina profissional',
      'subtitulo': 'Cuidado e dedicação ao seu ambiente',
      'categoria': 'Limpeza',
    },
    {
      'imagem':    'assets/images/banner_dev.png',
      'titulo':    'Precisa de um Profissional de TI?',
      'subtitulo': 'Suporte técnico, redes, computadores e muito mais',
  ...
  static const List<Map<String, dynamic>> _categoriasGrid = [
    ...
    {'nome': 'Frete',                       'icon': Icons.local_shipping,          'cor': Color(0xFFFF9800)},
  ...
  Future<void> _sair() async {
    final confirmar = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Text('Sair da conta', style: TextStyle(fontWeight: FontWeight.w700)),
  ...
  Future<void> _virarProfissional() async {
    ...
    await FirebaseFirestore.instance.collection('users').doc(user.uid).update({'role': 'profissional'});
    await user.reload();
    if (!mounted) return;
    Navigator.of(context).pushAndRemoveUntil(
      MaterialPageRoute(builder: (_) => const AuthCheck()), (route) => false);
  ...
  void _buscar(String termo) {
    ...
    Navigator.push(context, MaterialPageRoute(
      builder: (_) => NovoPedidoPage(
          categoriaInicial: cat.isNotEmpty ? cat['nome'] as String : null),
    ));
  }
                          ...
                          child: ClipRRect(
                            ...
                            child: Stack(
                              ...
                              children: [
                                ...
                                // Badge "Solicitar" se tiver categoria
                                if (b['categoria']!.isNotEmpty)
                                  Positioned(
                                    top: 12, right: 12,
                                    child: Container(
        ...
        return SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              final String? foto       = (data['fotoUrl'] as String?)?.isNotEmpty == true ? data['fotoUrl'] as String : null;
                      final String? fotoBase64 = data['fotoBase64'] as String?;
              return Container(
                width: 130,
                ...
                child: Column(
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      child: foto != null
                          ? ClipOval(child: Image.network(foto!, width: 56, height: 56, fit: BoxFit.cover))
                          : fotoBase64 != null
                              ? ClipOval(child: Image.memory(
                                  base64Decode(fotoBase64.split(',').last),
                                  width: 56, height: 56, fit: BoxFit.cover))
                              : Text(primeiroNome[0].toUpperCase(),
                                  style: const TextStyle(fontSize: 22,
                                      fontWeight: FontWeight.w700, color: Color(0xFF276EF1))),
                    ),
                    const SizedBox(height: 8),
                    Text(primeiroNome,
                        style: const TextStyle(fontSize: 13,
                            fontWeight: FontWeight.w700, color: Color(0xFF222222)),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(media > 0 ? media.toStringAsFixed(1) : 'Novo',
