...
class _AreaProfissionalPageState extends State<AreaProfissionalPage> {
  ...
  // ✅ Limite considerado "saldo baixo" (abaixo do mínimo de recarga do Asaas)
  static const double _limiteSaldoBaixo = 5.0;
  ...
  Future<void> _desbloquearPedido(String pedidoId, String? chatId) async {
    ...
    try {
      ...
      // ✅ Saldo insuficiente para R$1 — agora com mensagem clara pro profissional
      if (saldo < 1) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              saldo <= 0
                  ? 'Você está sem saldo. Adicione saldo para desbloquear este contato.'
                  : 'Saldo insuficiente (é necessário R\$ 1,00). Adicione mais saldo.',
            ),
  ...
  // ✅ NOVO — alerta reutilizável de saldo baixo / sem saldo
  Widget _buildAlertaSaldo({
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              texto,
              style: TextStyle(fontSize: 12.5, fontWeight: FontWeight.w600, color: _white, height: 1.3),
            ),
          ),
        ],
      ),
  ...
  Widget _buildSaldoBanner(User user) {
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, snap) {
        ...
        final bool semSaldo   = saldo <= 0;
        final bool saldoBaixo = !semSaldo && saldo < _limiteSaldoBaixo;
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // ✅ NOVO — alerta de sem saldo / saldo baixo
                      if (semSaldo) ...[
                        const SizedBox(height: 14),
                        _buildAlertaSaldo(
                          icone: Icons.error_outline_rounded,
                          texto: 'Você está sem saldo. Adicione para desbloquear novos contatos.',
                        ...
                        _buildAlertaSaldo(
                          ...
                          texto: 'Saldo baixo. Adicione mais para não ficar sem saldo.',
                          cor: _premiumGold,
                        ),
                      ],
